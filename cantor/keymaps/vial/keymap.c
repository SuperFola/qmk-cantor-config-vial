...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX,    OPT_T(KC_A),SFT_T(KC_S), CMD_T(KC_D), CTL_T(KC_F), LT(1, KC_G),     LT(1, KC_H), CTL_T(KC_J), CMD_T(KC_K), SFT_T(KC_L), KC_SCLN,    KC_LALT,
    ...
    [3] = LAYOUT_split_3x6_3(
        ...
        KC_BTN1, KC_LOPT, KC_LSFT, KC_LCMD, KC_LCTL, KC_TRNS,               KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_TRNS, KC_F14,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,               KC_TRNS, KC_VOLU, KC_VOLD, KC_MUTE, KC_TRNS, KC_F15,
                                   KC_TRNS, KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS, KC_TRNS
    ),
